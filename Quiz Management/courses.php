...
<form action="quequiz.php" method="POST" class="form-container">
...
<button type="submit" class="btn" name="submit">PLAY NOW!</button>
...
<section class="courses">
  <div class="container">
    <h1><span class="highlight">PLAY YOUR</span> FAVOURITE QUIZ</h1>
      <br>
      <div class="subject">
      <div class="ps1">
